...
public class STConfiguredStructures {
     ...
     */
    public static ConfiguredStructureFeature<?, ?> CONFIGURED_MARSHY_HUT = STStructures.MARSHY_HUT.get()
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(BaseMod.MODID, "configured_marshy_hut"), CONFIGURED_MARSHY_HUT);
    }
}