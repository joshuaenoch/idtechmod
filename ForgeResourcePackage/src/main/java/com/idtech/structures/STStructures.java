...
public class STStructures {
     ...
     */
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, BaseMod.MODID);
     ...
     */
    public static final RegistryObject<StructureFeature<JigsawConfiguration>> MARSHY_HUT = DEFERRED_REGISTRY_STRUCTURE.register("marshyhut", () -> (new MarshyHutStructure(JigsawConfiguration.CODEC)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                MARSHY_HUT.get(), /* The instance of the structure */
